          ...
          >
            <div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500">
              ...
              <div className="menu-item menu-accordion">
                ...
                >
                  <div className="menu-item">
                    <Link href="/admin/appointments" className="menu-link">
                      <span className="menu-icon">
                        <span className="svg-icon svg-icon-2">
                  ...
                  <div className="menu-item">
                    <a className="menu-link" href={"/admin/appointments-add"}>
                      <span className="menu-icon">
                        <span className="svg-icon svg-icon-2">
                          <FontAwesomeIcon icon={faUserPlus} />
                        </span>
                      </span>
                      <span className="menu-title">Add Appointment</span>
                    </a>
                  </div>
                </div>
              </div>
              <div className="menu-item">
                <Link href="/admin/patients" className="menu-link">
                  <span className="menu-icon">
